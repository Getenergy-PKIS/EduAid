...
const TargetGroupCard = ({ title, description, icon, index }: TargetGroupCardProps) => {
...
export default function TargetGroup() {
  const targetGroups = [
    {
      title: 'Students',
      description: 'Offering scholarships, digital learning resources, and opportunities to participate in educational programs that expand their potential.',
      icon: (
    ...
    },
    {
      ...
      description: 'Providing capacity-building services, training, and infrastructure development to ensure educators can deliver quality education.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: 'Collaborating with businesses to leverage CSR programs focused on education, ensuring transparency, accountability, and impact.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: 'Engaging communities across Africa and globally to support educational improvement through conferences, exchanges, and collaborative initiatives.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          >
            EduAid Africa&apos;s programs and initiatives are designed to impact the following target groups
          </motion.p>
        </motion.div>
